...
function trackMousePosition() {
  const cursorMouseMove = function(event) {
  ...
  setTimeout(() => {
    ...
    console.log('stop recording cursor movement');
  }, 2500); // Timer 250ms to stop moving cursor 
...
function createTestList() {
  document.body.innerHTML = `
    ...
    <h1>My JS Events home-work-26</h1>
...
export { handleButtonClick, trackMousePosition, setupEventDelegation, createTestList };